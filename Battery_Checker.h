...
#define TEMP_LOW_WARNING_LOWLIMIT      (float)(TEMP_LOW_LIMIT + 0.01)
#define TEMP_LOW_WARNING_HIGHLIMIT     (float)(TEMP_LOW_LIMIT + TEMP_TOLERANCE_LIMIT)
#define TEMP_NORMAL_LOWLIMIT           (float)(TEMP_LOW_WARNING_HIGHLIMIT + 0.01)
#define TEMP_HIGH_WARNING_LOWLIMIT     (float)(TEMP_HIGH_LIMIT - TEMP_TOLERANCE_LIMIT)
#define TEMP_NORMAL_HIGHLIMIT          (float)(TEMP_HIGH_WARNING_LOWLIMIT - 0.01)
#define TEMP_HIGH_WARNING_HIGHLIMIT    (float)(TEMP_HIGH_LIMIT)
#define TEMP_HIGH_BREACH_LOWLIMIT      (float)(TEMP_HIGH_LIMIT + 0.01)
...
#define CR_LOW_WARNING_LOWLIMIT        (float)(CR_LOW_LIMIT + 0.001)
#define CR_LOW_WARNING_HIGHLIMIT       (float)(CR_LOW_LIMIT + CR_TOLERANCE_LIMIT)
#define CR_NORMAL_LOWLIMIT             (float)(CR_LOW_WARNING_HIGHLIMIT + 0.001)
#define CR_HIGH_WARNING_LOWLIMIT       (float)(CR_HIGH_LIMIT - CR_TOLERANCE_LIMIT)
#define CR_NORMAL_HIGHLIMIT            (float)(CR_HIGH_WARNING_LOWLIMIT - 0.001)
#define CR_HIGH_WARNING_HIGHLIMIT      (float)(CR_HIGH_LIMIT)
#define CR_HIGH_BREACH_LOWLIMIT        (float)(CR_HIGH_LIMIT + 0.001)
